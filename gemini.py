...
8. create Relationship objects such that:
  ...
  - Relationship's properties must be different than its source's and target's properties
  - carefully enrich the properties with biomedical contextual cues for enhancing semantics
...
16. make the output JSON valid

the formatting instructions are: 

{{ format_instructions }}

16. you can not fail. should you fail return a null object
"""
